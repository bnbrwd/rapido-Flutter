import 'package:rapido_cubit/data/models/login_request.dart';
import 'package:rapido_cubit/data/models/login_response.dart';
import 'package:rapido_cubit/data/models/otp_verification_request.dart';
...
class Repository {
  ...
  Future<OtpVerificationResponse> verifyOtp(String otp, String token) async {
